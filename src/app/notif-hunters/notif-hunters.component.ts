...
@Component({
  selector: 'app-notif-hunters',
  templateUrl: './notif-hunters.component.html',
  styleUrls: ['./notif-hunters.component.css']
})
export class NotifHuntersComponent implements OnInit {
